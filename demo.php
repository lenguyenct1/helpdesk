...
$query = "select * from suco,giaiquyet where giaiquyet.id=suco.idsuco";
    ...
    <div id="employee_table">
     <table class="table table-bordered">
      ...
      <tr>
       ...
       <td><input type="button" name="view" value="view" id="<?php echo $row["idgq"]; ?>" class="btn btn-info btn-xs view_data" />
		  </td>
      </tr>
      <?php
      }
